...
export default {
  ...
  methods: {
    ...mapActions({
      getCommunes: 'commune/getItems',
    }),
    initialize() {
      if (this.communes.length === 0) this.getCommunes();
    },
    ...
    deleteItemConfirm() {
      this.communes.splice(this.editedIndex, 1);
      this.closeDelete();
    },
    ...
    save() {
      if (this.editedIndex > -1) {
        Object.assign(this.communes[this.editedIndex], this.editedItem);
      } else {
        this.communes.push(this.editedItem);
      }
      this.close();
    },
  },
